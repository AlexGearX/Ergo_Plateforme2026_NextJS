...
export function MaterielEditClient({ materiel, maisons, personnes }: Props) {
        ...
        <main className="mx-auto max-w-5xl px-4 pt-8 pb-24 sm:px-6 lg:px-8">
          ...
          <header className="mt-8">
            ...
            >
              ...
              Atelier · Édition · {MATERIEL_TYPE_LABELS[materiel.type]}
            </p>
            <div className="mt-4 flex items-end gap-5">
              ...
              <div className="pb-2">
                ...
                >
                  Modifier
                  <br />
                  <span className="text-accent-foreground">{materiel.modele}.</span>
                </h1>
              </div>
            </div>
            <p data-anim="lead" className="text-muted-foreground mt-5 max-w-lg text-[15px] leading-relaxed">
              Mettez à jour l’identification, l’affectation ou — pour un fauteuil — les spécificités. L’historique
              d’entretien se gère depuis la fiche.
            </p>
          </header>
